...
<div id="container-inside"> <span style="font-size:16px; font-weight:bold"><?php echo CAR_EXTRAS_ADD_AND_EDIT;?></span>
  <input type="button" value="<?php echo EXTRAS_BACK;?>" onClick="window.location.href='car-extras.php'" style="background: #EFEFEF; float:right; cursor:pointer; cursor:hand;"/>
  ...
  <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" id="form1">
    <table cellpadding="5" cellspacing="2" border="0">
      ...
      <tr>
        <td><strong><?php echo CAR_EXTRAS;?>:</strong></td>
