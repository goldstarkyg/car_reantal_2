...
<form name="lincence" action="install.step1.php" method="post" onsubmit="return licenceAggrement();">
  ...
  <table align="center" width="60%" cellspacing="0" cellpadding="0" border="0"  class="table1">
      ...
      <td align="left" class="table_bg" colspan="2">BSI  CAR RENTAL SYSTEM</td>
    ...
    <tr><td  class="table_content" align="justify" colspan="2"> All copyrights to BSI  CAR RENTAL SYSTEM are exclusively owned by the authors: Best Soft Inc (http://www.bestsoftinc.com) </td>
    ...
    <tr>
      ...
      <td class="table_content" align="justify" colspan="2">This EULA is a CONTRACT between you and Best Soft Inc which covers your use of the software product that accompanies this EULA. The software will be referred to herein as the "Software Product". A software license, issued to a designated user only by BestSoft Inc, is required for each user of the Software Product.</td>
    ...
    <tr>
      ...
      <td class="table_content" align="center" colspan="2"> Thank you for using BSI  CAR RENTAL SYSTEM.<br />
